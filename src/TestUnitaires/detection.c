...
void detectionMarque(int N){
	...
	printf ("#########################################################################\n");
	printf ("#			TEST DE LA DETECTION				#\n");
	printf ("#########################################################################\n");
	
	if (echec/NWB >= 50)
	{
		printf("Test de la détection : Non");
		return EXIT_FAILURE;
	}

	printf("#									#\n");
	printf("#		Test de la détection : OK				#\n");
	printf("#									#\n");
	printf("#									#\n");
	printf("#		%'.2f%% des blocs marqués n'ont pas été détectés.		#\n",((float)echec/NWB)*100);
	printf("#									#\n");
	printf("#	Pour louper les tests, il aurait fallu que plus de 50%%		#\n");
	printf("#		des blocs ne soient pas détectés			#\n");
	printf("#									#\n");
	printf ("#########################################################################\n");
